...
public class Library {
    ...
    public final class MP3_Database {
        ...
        public void deleteDeletedSongsFromPlaylists(Connection 
         DatabaseConnection, Object songKey) {
            if (DatabaseConnection != null){
                try (Statement stmt = DatabaseConnection.createStatement( )) {
                    String query = "DELETE FROM PLAYLIST_SONGS WHERE";
        ...
        //by the user.
        public ArrayList<String> assignColumnValues(Connection 
         DatabaseConnection, boolean Album, boolean Artist, boolean Year, 
